...
public:
    ...
    void setupUi(QMainWindow *Alice)
    {
        ...
        publickey_text->setFont(font);
        publickey_text->setLineWrapMode(QPlainTextEdit::LineWrapMode::WidgetWidth);
        ...
        sendmessage_button->setFont(font);
